...
int withdraw_page()
{
	...
	if (customer[user].balance > acc_types[(customer[user].acc_type) - 1].max_withdraw)
	{
		cout << "\tYou can withdraw upto: " << acc_types[(customer[user].acc_type) - 1].max_withdraw << endl;
		accept("\tEnter the withdraw amount: ", &cash, acc_types[(customer[user].acc_type) - 1].initial, customer[user].balance - acc_types[(customer[user].acc_type) - 1].max_withdraw);
	}
	else
	{
		cout << "\tYou can withdraw upto: " << customer[user].balance - acc_types[(customer[user].acc_type) - 1].initial << endl;
		accept("\tEnter the withdraw amount: ", &cash, acc_types[(customer[user].acc_type) - 1].initial, customer[user].balance - (acc_types[(customer[user].acc_type) - 1]).initial);
	}
...
chance:
			...
			cout << "\tRemaining Balance: " << (1 + acc_types[(customer[user].acc_type) - 1].interest) * customer[i].balance << endl;
